...
PennController.Template(
    PennController.GetTable("spr.csv"),  // load your csv
    variable => PennController("trial",
                               ...
                               .wait()
                               ,
                               newText("less", variable.less)  // and we change the quoted text to equal variable.column
                               .settings.italic()
                               .print()
                               ,
                               newKey("less", " ")
                               ...
                               .remove()
                               ,
                               newText("adj", variable.adj)  // and we change the quoted text to equal variable.column
                               .settings.italic()
                               .print()
                               ,
                               newKey("adj", " ")
                               ...
                               .remove()
                               ,
                               newText("noun", variable.np)  // and we change the quoted text to equal variable.column
                               .settings.italic()
                               .print()
                               ,
                               newKey("noun", " ")
                               ...
                               .remove()
                               ,
                               newText("verb", variable.verb)  // and we change the quoted text to equal variable.column
                               .settings.italic()
                               .print()
                               ,
                               newKey("verb", " ")
                               ...
                               .remove()
                               ,
                               newText("adv", variable.adv)  // and we change the quoted text to equal variable.column
                               .settings.italic()
                               .print()
                               ,
                               newKey("adv", " ")
                               ...
                               .wait()
                               ,
                               getKey("less").settings.log(),
                                getKey("adj").settings.log(),
                                getKey("noun").settings.log(),
                                getKey("verb").settings.log(),
                                getKey("adv").settings.log()
                              )
    // Log item variables
